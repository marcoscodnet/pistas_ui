...
use Pistas\UI\components\grid\model\PistaSinMenuGridModelNuevo;
 ...
 * 
 */
class PistasSinMenuNuevo extends PistasPage{
	...
	public function __construct(){
		...
		$this->setExito(RastyUtils::getParamGET( "exito" ));
	}
	...
	public function getType(){
		...
		return "PistasSinMenuNuevo";
		
	}	

	public function getModelClazz(){
		return get_class( new PistaSinMenuGridModelNuevo() );
	}
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign("legend_resultados", $this->localize("grid.speech") );
		...
		if( !empty($msg) ){
			...
			$xtpl->assign("msgExito", $msg);
			//$xtpl->assign("msg",  );
			$xtpl->parse("main.msg_exito" );
		}
